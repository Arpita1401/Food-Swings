...
<?php
    if(isset($_GET['food_id']))
    {
        ...
        $sql4="SELECT * FROM tbl_food WHERE id=$food_id";
        ...
        <div class="container">
            ...
            <form action=""  method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="Type your full name" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="Phone number" class="input-responsive" required>

                    <div class="order-label">Email</div>
                    <input type="email" name="email" placeholder="johndoe@gmail.com" class="input-responsive" required>
                ...
                if($res1 == TRUE)
            {
                //Data inserted
                //SEssion variable
                $_SESSION['order']= "<div class='success'>Food order confirmed</div>";
                //Redirect page
                header("Location:".SITEURL);
            }
            else
